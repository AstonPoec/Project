         ...
         <div class="column_right">
          <!--Sidebar content-->
          	<ul class="nav nav-pills nav-stacked">
    			...
    			<li role="presentation"><a href="#statistiques" aria-controls="statistiques" role="tab" data-toggle="tab">Statistiques</a></li>
...
<!-- CLASSE -->
	<div class="col-xs-5 col-sm-5 col-md-4">
		<div class="form-group">
  			<label for="selectClasse" class="col-md-4">Classe</label>
  			<div class="col-md-8 col-md-push-1 selectContainer">
	  			<select name="classe" class="form-control input-sm" id="selectClasse"> 
	  				<option value=""></option>
	                <option value="">POEC Java</option>
	                <option value="">POEC Php</option>
	                <option value="">CQP DNT</option>
...
<!-- DIPLOME -->
	<div class="col-xs-5 col-sm-5 col-md-4">
		<div class="form-group">
  			<label for="selectDiplome" class="col-md-4 col-md-push-1">Diplome</label>
  			<div class="col-md-8 selectContainer">
	  			<select name="diplome" class="form-control input-sm" id="selectDiplome">
	  		 		<option value=""></option>
...
<!-- ECOLE -->	
	<div class="col-xs-5 col-sm-5 col-md-4">	
  		<div class="form-group">
    		<label for="inputEcole" class="col-md-4 col-md-push-2">Ecole</label>
    		<div class="col-md-8">
    			<input type="text" name="ecole" class="form-control input-sm" id="inputEcole" placeholder="" tabindex="1">
  			</div>  
  		</div>		
	</div>
<!-- COMPETENCE -->	
